...
export const heTowingServices = [
  {
    title: 'רכבי 4X4',
    description: "גרירה וחילוץ של: רכבים פרטיים, ג'יפים, טנדרים, טרקטורונים, ארזדרים, וכל מה שזז בשטח. חילוץ מחול, מבוץ, מקרקע סלעית או טרשית 24/7"
  },
  {
    title: 'גרירה עבור גופים ומוסדות ציבוריים',
    description: 'שרות מלא לגופים ומוסדות. חשבונית מס כנגד כל עבודה. דייקנות אמינות ומצויינות'
  },
  {
    title: 'גרירה בכוננות לאירועים',
    description: 'נותנים שרות בכל רכבי הארץ, גם לאירועים בחיק הטבע, גם באירועים במקומות סגורים ותחת כיפת השמיים. חשבונית מס, אמינות דייקנות ומצויינות. ליווי מלא לאורך כל האירוע'
  },
  {
    title: 'גרירת רכב חקלאי',
    description: 'שרות לחקלאים: גרירת רכב חקלאי עד משקל טון וחצי שרות באזור המרכז בכל שעה'
  },
  {
    title: 'גרירת רכב שרוף',
    description: 'גרירה וחילוץ רכב שרוף בשיטות מתקדמות, בכל מצב ומכל מקום'
  },
  {
    title: 'רכב דו גלגלי',
    description: 'גרירת אופנועים כבדים. השירות מתבצע בכל הארץ בתיאום מראש'
  },  
  {
    title: 'גרירות רכב מיוחדות',
    description: 'גרירת רכבי אספנות, רכבים שלא זזו שנים, רכבים שנמצאים בשדה פתוח, בחניונים, או כל מקום אחר שעולה על הדעת אצלי ישנו הפתרון! 24/7'
  }
];

export const heRoadSide = [  
 {
    title: 'מצברים',
   ...
   {
    title: 'החלפת גלגל',
    description: 'החלפת גלגל במקרה של תקר 24/7'
  },
     {
    title: 'שירות תדלוק',
    description: 'נתקעתם בלי דלק? התקשרו ונגיע עד אליכם 24/7'
  },
  {
    title: 'פינוי צירים',
    description: 'חילוץ והצלה, גרירה 24/7, פינוי ופתיחת כל ציר באזור המרכז בצורה מקצועית ומהירה'
  },   
  {
    title: 'חילוץ רכב ממים',
    description: 'חילוץ רכב ממים - חילוץ רכבים מחניונים מוצפים מרחובות מוצפים מנחלים, מהים, או כל מקום אחר כשהרכב נמצא בתוך מים. 24/7 לשירותכם'
  }
];

export const heGeneralServices = [  
  {
    title: 'מצברים',
    description: 'גרירה, התקנה ואחריות לשנה של מצברים לכל סוגי הרכב, התקנה גם בבית הלקוח(באזור המרכז) 24/7'
  },
  {
    title: 'גרירת כל סוגי הרכבים הפרטיים',
    description: 'גרירה ושירותי דרך לכל סוגי הרכבים הפרטיים'
  },
  {
    title: 'גרר בשטח',
    description: "גרירת רכבי 4X4, ג'יפים, טנדרים ורכבים פרטיים, או כל רכב אחר שנע בשטח. החילוץ מתבצע בשטח חולי או טרשי, ים, או כל דבר אחר בצורה מקצועית"
  },
  {
    title: 'חילוץ מחניונים',
    description: 'חילוץ מחניונים, ממקומות נמוכים, מגדלי מגורים או כל חניון אחר. עד גובה 1.90 24/7'
  },
  {
    title: 'שרותי התנעה',
    description: 'התנעת כל סוגי הרכבים- בכל מקום, בכל שעה. אפשרות למכירת מצברים חדשים עם אחריות לשנה. התקנה גם בבית הלקוח. אפשרות להתקנה גם בשטח או בכל מקום אחר. בכל שעה 24/7 לשירותכם'
  },
  {
    title: 'חילוץ משטח חולי וטרשי',
    description: "חילוץ והצלה של רכבי 4X4, ג'יפים, טנדרים ורכבים פרטיים, או כל רכב אחר שנע בשטח. החילוץ מתבצע בשטח חולי או טרשי, ים, או כל דבר אחר בצורה מקצועית"
  },
];
export const heOtherServices = [
  {
    title: 'אחסנת רכבים',
    description: 'אחסנת רכבים ללילה או לתקופות קצרות וארוכות יותר, בתיאום טלפוני 24/7'
  }  
];
